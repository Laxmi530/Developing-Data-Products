...
###  Part 1 Plot the 30-day mortality rates for heart attack ([outcome.R](https://github.com/Laxmi530/ProgrammingAssignment2/blob/master/outcome.R))
...
outcome[, lapply(.SD
        ...
        , .SDcols = (11)]
```
![ProgrammingAssignment2](https://github.com/Laxmi530/ProgrammingAssignment2/blob/master/Hospital_30_day_death.png)
###  Part 2 Finding the best hospital in a state ([best.R](https://github.com/Laxmi530/ProgrammingAssignment2/blob/master/best.R))
```R
...
```
###  Part 3 Ranking hospitals by outcome in a state ([rankhospital.R](https://github.com/Laxmi530/ProgrammingAssignment2/blob/master/rankhospital.R))
```
Rrankhospital <- function(state, outcome, num = "best") {
...
```
###  Part 4 Ranking hospitals in all states ([rankall.R](https://github.com/Laxmi530/ProgrammingAssignment2/blob/master/rankall.R))
```R
